window.start3PlayerGame = function() {
    if (window.gameInstance) {
        window.gameInstance.destroy();
    }
    window.gameInstance = new PongGameThreePlayer("gameCanvas");
};
...
class PongGameThreePlayer {
    constructor(canvasId) {
        ...
        this.keys = { w: false, s: false, ArrowUp: false, ArrowDown: false, c: false, v: false };
    ...
    update() {
        ...
        if (this.keys.c && this.paddle3Y > 0) this.paddle3Y -= this.paddleSpeed;
        if (this.keys.v && this.paddle3Y < this.fieldHeight - this.paddleHeight) this.paddle3Y += this.paddleSpeed;
    ...
    resetBall() {
        if (this.player1Score >= this.maxScore || this.player2Score >= this.maxScore || this.player3Score >= this.maxScore) {
            this.running = false;
        }
        this.ballX = this.fieldWidth / 2;
        this.ballY = this.fieldHeight / 2;
        ...
        if (this.player1Score >= this.maxScore) {
            ...
            formData.append('player2', this.player2Name + " & " + this.player3Name);
